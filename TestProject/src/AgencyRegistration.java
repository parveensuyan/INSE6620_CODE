...
import java.sql.*;
import java.util.*;
public class AgencyRegistration implements ActionListener {
    ...
    JLabel agencycode=new JLabel("Agency Code");
    ...
    JTextField agencyTextField=new JTextField();
    ...
    {          JScrollBar oneJScrollBar = new JScrollBar(JScrollBar.HORIZONTAL);
       ...
       //Setting properties of JFrame
        frame=new JFrame();
        frame.setTitle("Agency Registration Form");
    ...
    public void setLocationAndSize() {
        ...
        agencycode.setBounds(20,520,100,70);
        ...
        agencyTextField.setBounds(180,543,165,23);
    ...
    public void actionPerformed(ActionEvent e) {
    	   if(e.getSource()==registerButton)
           {
               try {
                   ...
                   PreparedStatement Pstatement1=connection.prepareStatement("select EMAIL from agency where EMAIL = ?");
                   ...
                   rs.close();
                   //Preapared Statement
                   PreparedStatement Pstatement=connection.prepareStatement("insert into agency(name,"
                   		+ "address,PASSWRD,CONFIRMPASSWRD,CITY,EMAIL,street,country,postalcode,"
                   		+ "contact,"
                   		+ "agencycode,certified) values(?,?,?,?,?,?,?,?,?,?,?,?)");
...
//                   Pstatement.setString(1,'4');
                   ...
                   Pstatement.setString(11,agencyTextField.getText());
